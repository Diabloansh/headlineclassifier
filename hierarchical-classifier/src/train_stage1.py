"""Training script for Stage 1 — topic classification (health vs technology)."""
...
from dataset import create_topic_datasets
...
def train_epoch(model, dataloader, optimizer, scheduler, device):
    ...
    for batch in tqdm(dataloader, desc="Training [Stage 1]"):
        optimizer.zero_grad()
...
def main():
    parser = argparse.ArgumentParser(description="Train Stage 1 — topic classifier")
    ...
    # ---- datasets ----
    train_dataset, val_dataset, test_dataset, tokenizer = create_topic_datasets(
    ...
    print("=" * 60)
    print("  Stage 1 — Topic Classifier (health vs technology)")
    print("=" * 60)
