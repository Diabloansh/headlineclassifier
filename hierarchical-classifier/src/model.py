"""BERT-based classifier used for both stages of the hierarchical pipeline.

Stage 1: num_labels=2  (health vs technology)
Stage 2: num_labels=3  (central, peripheral, neutral)
"""
...
class HeadlineClassifier(nn.Module):
    """BERT-based classifier parameterised by num_labels."""
